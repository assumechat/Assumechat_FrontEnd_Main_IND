            ...
            <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4">
                <div className="w-full max-w-md bg-white rounded-lg shadow-sm p-8 border border-gray-200">
                    <div className="text-center mb-8">
                        <h1 className="text-2xl font-bold text-gray-900 mb-2">Submit a Feature or Bug Report</h1>
                        <p className="text-gray-600">Help us improve by sharing your issues, ideas or suggestions</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            ...
                            <input
                                ...
                                required
                            />
                            <p className="mt-1 text-xs text-gray-500">Brief description of your issue or idea</p>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                {[
                                    { value: 'enhancement', icon: <Wand2 className="mx-auto h-5 w-5 mb-1" />, label: 'Enhancement', description: 'Improve an existing feature' },
                                    { value: 'bug', icon: <Bug className="mx-auto h-5 w-5 mb-1" />, label: 'Bug Fix', description: 'Report a bug or issue' },
                                    { value: 'feature', icon: <Wand2 className="mx-auto h-5 w-5 mb-1" />, label: 'New Feature', description: 'Suggest a new feature' },
                                    { value: 'other', icon: <CircleHelp className="mx-auto h-5 w-5 mb-1" />, label: 'Other', description: 'Other type of request' },
                                ].map(option => (
                                    <label
                                        key={option.value}
                                        className={`flex items-center justify-center p-3 border rounded-md cursor-pointer ${formData.type === option.value ? 'border-[#B30738] bg-[#B30738]/10' : 'border-gray-300'}`}
                                    >
                                        <input
                                            type="radio"
                                            name="type"
