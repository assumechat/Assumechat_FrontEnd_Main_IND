...
import { Code, Paintbrush, Music, Film, Tv, BookOpen } from "lucide-react";
...
export default function InterestSelection() {
  ...
  const options = [
    ...
    {
      id: "diff-major",
      label: "Students from different major (I want a new POV)",
    },
    ...
    <div className="relative min-h-screen pt-16 md:pt-10 overflow-hidden bg-white">
      ...
      <div className="relative px-4 md:px-16 z-10 min-h-screen flex flex-col">
        ...
        <div className="flex justify-end p-4 sm:p-6">
          <span className="text-[#B30738] font-semibold text-sm sm:text-md">
            Step {step} of 3
          </span>
        </div>
