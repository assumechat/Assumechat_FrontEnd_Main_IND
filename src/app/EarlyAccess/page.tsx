  ...
  const FloatingIcon = ({
    ...
    const iconComponents = {
      premium: (
        ...
        >
          <path
            d="M4.5 9.7572L12 4.7572L19.5 9.7572V19.7572C19.5 20.2876 19.2893 20.7963 18.9142 21.1714C18.5391 21.5465 18.0304 21.7572 17.5 21.7572H6.5C5.96957 21.7572 5.46086 21.5465 5.08579 21.1714C4.71071 20.7963 4.5 20.2876 4.5 19.7572V9.7572Z"
            stroke="#B30738"
            strokeWidth="2"
            strokeLinecap="round"
      ...
      <div className="relative min-h-screen w-full overflow-hidden bg-white flex flex-col items-center justify-center">
        ...
        <div className="relative pt-0 z-10 text-center px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Get <span className="text-[#B30738]">Early Access</span> <br /> With
            1 Month Free Premium
          </h1>

          <p className="text-gray-800 text-lg max-w-lg mx-auto mb-8">
            Join the exclusive IIT social network before everyone else and enjoy
            premium benefits for free during your first month.
          </p>
          ...
          <p className="text-gray-600 text-md">
            ...
            <span className="text-[#B30738]">100 IITians</span> to join and get
            permanent early adopter status.
          </p>
        </div>
      </div>
