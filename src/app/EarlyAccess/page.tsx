...
export default function EarlyAccessPage() {
    ...
    const BenefitCard = ({ index, positionClass, title, description, emoji }: {
        index: number;
    ...
    const FloatingIcon = ({ index, positionClass, icon }: {
        index: number;
        positionClass: string;
        icon: 'premium' | 'rocket' | 'crown' | 'zap' | 'clock';
    }) => {
        const iconComponents = {
            premium: (
                <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M4.5 9.7572L12 4.7572L19.5 9.7572V19.7572C19.5 20.2876 19.2893 20.7963 18.9142 21.1714C18.5391 21.5465 18.0304 21.7572 17.5 21.7572H6.5C5.96957 21.7572 5.46086 21.5465 5.08579 21.1714C4.71071 20.7963 4.5 20.2876 4.5 19.7572V9.7572Z" stroke="#B30738" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M9 12.7572L15 18.7572" stroke="#B30738" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M15 12.7572L9 18.7572" stroke="#B30738" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
            ),
            rocket: (
                <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 15.7572C13.6569 15.7572 15 14.414 15 12.7572C15 11.1003 13.6569 9.7572 12 9.7572C10.3431 9.7572 9 11.1003 9 12.7572C9 14.414 10.3431 15.7572 12 15.7572Z" stroke="#B30738" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M12 15.7572V21.7572" stroke="#B30738" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M7.5 16.2572L4.5 19.2572" stroke="#B30738" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M16.5 16.2572L19.5 19.2572" stroke="#B30738" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M16.5 3.7572C16.5 6.2572 15 9.7572 12 12.7572C9 9.7572 7.5 6.2572 7.5 3.7572C7.5 3.22677 7.71071 2.71806 8.08579 2.34299C8.46086 1.96791 8.96957 1.7572 9.5 1.7572H14.5C15.0304 1.7572 15.5391 1.96791 15.9142 2.34299C16.2893 2.71806 16.5 3.22677 16.5 3.7572Z" stroke="#B30738" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
            ),
            crown: (
                <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M19 19.7572H5C4.46957 19.7572 3.96086 19.5465 3.58579 19.1714C3.21071 18.7963 3 18.2876 3 17.7572V7.7572C3 7.22677 3.21071 6.71806 3.58579 6.34299C3.96086 5.96791 4.46957 5.7572 5 5.7572H19C19.5304 5.7572 20.0391 5.96791 20.4142 6.34299C20.7893 6.71806 21 7.22677 21 7.7572V17.7572C21 18.2876 20.7893 18.7963 20.4142 19.1714C20.0391 19.5465 19.5304 19.7572 19 19.7572Z" stroke="#B30738" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M12 15.7572V12.7572" stroke="#B30738" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M12 12.7572L14 10.7572" stroke="#B30738" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M12 12.7572L10 10.7572" stroke="#B30738" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M3 9.7572L6 12.7572L9 7.7572" stroke="#B30738" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M21 9.7572L18 12.7572L15 7.7572" stroke="#B30738" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
            ),
            zap: (
                <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M13 2.7572L3 14.7572H12L11 22.7572L21 10.7572H12L13 2.7572Z" stroke="#B30738" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
            ),
            clock: (
                <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 8.7572V12.7572L15 15.7572" stroke="#B30738" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M12 21.7572C16.9706 21.7572 21 17.7278 21 12.7572C21 7.78663 16.9706 3.7572 12 3.7572C7.02944 3.7572 3 7.78663 3 12.7572C3 17.7278 7.02944 21.7572 12 21.7572Z" stroke="#B30738" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
            )
        };
        ...
        <>
            <div className="relative min-h-screen w-full overflow-hidden bg-white flex flex-col items-center justify-center">
                ...
                <BenefitCard
                    ...
                    description="Full access to all exclusive features"
                    emoji="🎁"
                />
                <BenefitCard
                    index={1}
                    ...
                    description="Stand out with premium verification"
                    emoji="✅"
                />
                <BenefitCard
                    index={2}
                    ...
                    description="Never get stuck in awkward convos"
                    emoji="⏭️"
                />
                <BenefitCard
                    index={3}
                    ...
                    title="No Waiting"
                    description="Skip the 1-minute timer"
                    emoji="⚡"
                />
                <BenefitCard
                    index={4}
                    positionClass="md:bottom-20 md:left-1/10 w-14 bottom-12 left-4"
                    title="All Games Unlocked"
                    description="From 'Assume Me' to 'Roast Me'"
                    emoji="🎮"
                />
                <BenefitCard
                    index={5}
                    ...
                    description="Pure connection, no distractions"
                    emoji="🚫"
                />
                ...
                <div className="relative pt-0 z-10 text-center px-4">
                    <h1 className="text-4xl md:text-5xl font-bold mb-6">
                        Get <span className='text-[#B30738]'>Early Access</span> <br /> With 1 Month Free Premium
                    </h1>

                    <p className="text-gray-800 text-lg max-w-lg mx-auto mb-8">
                        Join the exclusive IIT social network before everyone else and enjoy premium benefits for free during your first month.
                    </p>
                    ...
                    <p className="text-gray-600 text-md">
                        Limited spots available. Be among the first <span className="text-[#B30738]">500 IITians</span> to join and get permanent early adopter status.
                    </p>
                </div>
            </div>
        </>
