      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 py-12 sm:px-6">
        ...
        <div className="text-center max-w-2xl mb-8">
          ...
          <p className="text-gray-600 text-lg">
            While we find your next curious stranger, explore the campus of
            Bizzsocial.
          </p>
        </div>
        ...
        <div className="flex justify-center items-center flex-wrap gap-6 w-full  mb-10">
          {/* Watch Reels card */}
          <div
            onClick={() => router.push("waitingRoom/tabs/reels")}
            className="bg-white  p-5 rounded-xl border border-gray-200 overflow-hidden hover:shadow-md transition-shadow"
          >
            <div className="h-auto rounded-xl flex items-center justify-center">
              <Image
                ...
                width={500}
                src={
                  "https://res.cloudinary.com/dipywb0lr/image/upload/v1746624614/Frame_22_oetb3k.png"
                }
              />
            </div>
            <div className="">
          ...
          <div
            ...
            className="bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-md p-5 transition-shadow"
          >
            <div className="h-auto  rounded-xl  flex items-center justify-center">
              <Image
                className="w-full mb-4 h-full object-contain"
                ...
                width={500}
                src={
                  "https://res.cloudinary.com/dipywb0lr/image/upload/v1746624613/Frame_22_1_zv9xvj.png"
                }
              />
            </div>
            <div className="">
          ...
          >
            <div className="h-auto  rounded-xl  flex items-center justify-center">
              <Image
                ...
                width={500}
                src={
                  "https://res.cloudinary.com/dipywb0lr/image/upload/v1746624613/Frame_22_2_b3vjav.png"
                }
              />
            </div>
            <div className="">
        ...
        <div className="text-center max-w-2xl">
          <p className="text-[#B30738] font-medium ">
            We'll pull you into a chat as soon as we find a match.In the
            meantime, enjoy the campus vibes.
          </p>
        </div>
      </div>
    </div>
