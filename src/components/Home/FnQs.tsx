                ...
                <div className=" flex justify-center w-full items-start ">
                    <Accordion className="w-full flex  flex-col gap-4" type="single" collapsible>
                        <AccordionItem className=" w-full border-[#BABABA] border-2 px-4 rounded-lg" value="item-1">
                            <AccordionTrigger className="md:text-xl text-md w-full font-semibold">What is BizzSocial?</AccordionTrigger>
                            <AccordionContent className="text-sm md:text-lg">
                                BizzSocial is a “reverse social-media” platform—think of it as an exclusive Omegle just for your campus where you meet new people first and let existing friends shape your online identity later.
                            </AccordionContent>
                        </AccordionItem>
                        <AccordionItem className="border-2 w-full border-[#BABABA] px-4 rounded-lg" value="item-2">
                            ...
                            <AccordionContent className="text-sm md:text-lg">
                                Traditional networks start with people you know and reward self-promotion. BizzSocial flips both ideas: you’re paired anonymously with classmates you haven’t met, and only others can add posts or “assumptions” to your profile, so your public image is built from outside-in, not inside-out.
                            </AccordionContent>
                        </AccordionItem>
                        ...
                        <AccordionItem className="border-2 w-full border-[#BABABA] px-4 rounded-lg" value="item-5">
                            ...
                            <AccordionContent className="text-sm md:text-lg">
                                The core experiment is to hear how others actually see you. By outsourcing posts to friends and strangers, BizzSocial exposes blind spots and unspoken perceptions you’d never discover on a standard profile.
                            </AccordionContent>
                        </AccordionItem>
                        ...
                        <AccordionItem className="border-2 w-full border-[#BABABA] px-4 rounded-lg" value="item-9">
                            <AccordionTrigger className="md:text-xl text-md w-full font-semibold">Can BizzSocial help with loneliness and mental wellbeing?</AccordionTrigger>
                            <AccordionContent className="text-sm md:text-lg">
