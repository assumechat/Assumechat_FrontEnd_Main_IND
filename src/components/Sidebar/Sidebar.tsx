...
const Header = () => {
  ...
  const getSubTabs = () => {
    switch (currentTab) {
      ...
      case "minigames":
        return [{ id: "saved-games", icon: Bookmark, label: "Saved Games" }];
      case "unispace":
        return [
              ...
              <nav className="flex flex-col py-4 px-1 space-y-4">
                ...
                <div className="bg-white border border-[#B30738] rounded-lg py-3 px-1 mr-4  flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <span className="text-sm font-medium">
                      {waiting || 0} User Waiting
                    </span>
                  </div>
                </div>
                <div className="space-y-1 py-2 px-0  mr-4">
                  {mainTabs.map((tab) => (
                    <Link
                      key={tab.id}
                    ...
                    >
                      ...
                      <div className="bg-[#B30738] mr-3 p-2 flex justify-center rounded-lg items-center">
                        <tab.icon
                          color={currentTab === tab.id ? "white" : "white"}
                          size={20}
                        />
                      </div>
                ...
                <div className="flex flex-col space-y-3 pt-2 mr-4">
                  {isAuthenticated ? (
                    <Link
                      href="/"
                      className={`
...
const Sidebar = ({ Children }: { Children: ReactNode }) => {
  ...
  return (
    <div className="flex w-full h-screen">
      ...
      <div className="flex-1 w-full overflow-y-auto md:ml-72 ">{Children}</div>
    </div>
  );
};
